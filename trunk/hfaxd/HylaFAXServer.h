/*	$Id: HylaFAXServer.h 1108 2012-06-26 03:56:56Z faxguy $ */
/*
...
enum Token {
    ...
    T_DELMODEM,	 T_DISABLE,	T_ENABLE,	T_EPSV,		T_EPRT,		T_FILEFMT,	T_FORM,
    ...
    T_DOCUMENT,	 T_DONEOP,	T_EXTERNAL,	T_FAXNUMBER,	T_FAXNAME,	T_FROM_COMPANY,	T_FROM_LOCATION,
    T_FROM_USER, T_FROM_VOICE,	T_GROUPID,	T_HRES,		T_IGNOREMODEMBUSY, T_JOBID,
    T_JOBINFO,	 T_JOBTYPE,	T_LASTTIME,	T_MAXDIALS,
    ...
    T_RETRYTIME, T_SCHEDPRI,	T_SENDTIME,	T_SKIPPAGES,	T_SKIPPEDPAGES,	T_STATE,	T_STATUS,	T_ERRORCODE,
    T_SUBADDR,	 T_TAGLINE,	T_TIMEOFDAY,	T_TIMEZONE,	T_TOTDIALS,	T_TOTPAGES,	T_TOTTRIES,	T_PROBEONLY,
    T_TO_COMPANY,T_TO_LOCATION,	T_TO_USER,	T_TO_VOICE,	T_TSI,		T_USE_CONTCOVER, T_NOCOUNTCOVER, T_SERVERDOCOVER,
    T_USE_ECM,	 T_ECMTYPE,	T_USE_TAGLINE,	T_USE_XVRES,	T_USE_COLOR,	T_USRKEY,	T_VRES, T_CONNTIME, T_DURATION,
    /*
     * SNPP tokens.
     */
