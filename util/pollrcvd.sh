#! /bin/sh
#	$Header: /usr/people/sam/fax/util/RCS/pollrcvd.sh,v 1.4 1994/06/17 19:08:55 sam Exp $
#
...
DECODE=uudecode
#
# pollrcvd mailaddr faxfile time protocol sigrate error-msg [devID]
#
if test $# != 6 -a $# != 5
then
    echo "Usage: $0 mailaddr faxfile time sigrate protocol error-msg [devID]"
    exit 1
fi
mailaddr=$1; shift
