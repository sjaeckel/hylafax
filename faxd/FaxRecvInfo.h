/*	$Header: /usr/people/sam/fax/./faxd/RCS/FaxRecvInfo.h,v 1.17 1995/04/08 21:30:20 sam Rel $ */
/*
...
public:
    ...
    u_int	pagewidth;	// page width (pixels)
    u_int	pagelength;	// page length (mm)
    u_int	resolution;	// resolution (dpi)
