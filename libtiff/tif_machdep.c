/* $Header: /usr/people/sam/fax/libtiff/RCS/tif_machdep.c,v 1.5 1994/05/16 18:52:55 sam Exp $ */
...
void
DECLARE3(TIFFCvtIEEEFloatToNative, TIFF*, tif, u_int, n, float*, f)
{
...
void
DECLARE3(TIFFCvtNativeToIEEEFloat, TIFF*, tif, u_int, n, float*, f)
{
	float_t *fp = (float_t *)f;
