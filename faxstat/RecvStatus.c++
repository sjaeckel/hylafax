/*	$Header: /usr/people/sam/fax/./faxstat/RCS/RecvStatus.c++,v 1.14 1995/04/08 21:34:43 sam Rel $ */
/*
...
FaxRecvStatus::FaxRecvStatus(const FaxRecvStatus& other)
    : fxObj(other)
    , date(other.date)
    , time(other.time)
    , sender(other.sender)
    , host(other.host)
{
    ...
    beingReceived = other.beingReceived;
}
FaxRecvStatus::~FaxRecvStatus() {}
