#! /bin/sh
#	$Header: /usr/people/sam/fax/port/bsdi/RCS/install.sh,v 1.6 1994/03/28 21:36:22 sam Exp $
#
...
#
# Shell script to emulate SGI install program under BSD/386.
#
preopts=""
postopts=""
SaveFirst="no";
...
do
    ...
    -u)		shift; CHOWN="/usr/sbin/chown $1";;
