#! /bin/sh
#	$Header: /usr/people/sam/fax/port/hpux/RCS/install.sh,v 1.2 1994/02/28 14:28:01 sam Exp $
#
...
#
# Shell script to emulate SGI install program under HPUX 9.0
#
preopts=
postopts=
SaveFirst=no
